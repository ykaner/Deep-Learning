...
tf.flags.DEFINE_string('data_dir', '/tmp/cifar10_data', """Path to the CIFAR-10 data directory.""")
tf.flags.DEFINE_boolean('use_fp16', False, """Train the model using fp16.""")
